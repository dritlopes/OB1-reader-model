...
def get_word_freq(pm, unique_words, n_high_freq_words = 500, freq_threshold = 1, verbose=True):
    ...
    output_word_frequency_map = r"C:\Users\Konstantin\Documents\OB1-reader-model-master\data\processed\frequency_map_{pm.stim_name}_{pm.task_to_run}_{pm.language}.json"
